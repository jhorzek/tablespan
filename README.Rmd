...
`tablespan` builds on the awesome packages [`gt`](https://gt.rstudio.com/), [`openxlsx`](https://ycphs.github.io/openxlsx/) , [`flextable`](https://ardata-fr.github.io/flextable-book/index.html), [`huxtable`](https://hughjonesd.github.io/huxtable/index.html), and [`googlesheets4`](https://googlesheets4.tidyverse.org). 
This allows `tablespan` tables to be exported to a large number of formats:
...
-   googlesheets4: Bryan, J. (2025). *googlesheets4: Access Google Sheets using the Sheets API V4*. R package version 1.1.2, <https://CRAN.R-project.org/package=googlesheets4>.
